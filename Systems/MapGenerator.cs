    ...
    public class MapGenerator
    {
        ...
        public DungeonMap CreateMap()
        {
            ...
            for (int r = _maxRooms; r > 0; r--)
            {
                ...
                int roomXPosition = Game.Random.Next(1, _width - roomWidth - 1);
                int roomYPosition = Game.Random.Next(1, _height - roomHeight - 1);
        ...
        {
            for (int y = System.Math.Min(yStart, yEnd); y <= System.Math.Max(yStart, yEnd); y++)
            {
